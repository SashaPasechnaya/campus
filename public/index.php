        ...
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="https://iasa.kpi.ua/asset/images/jeshoots-com-pUAM5hPaCRI-unsplash.jpg">
                    <div class="button-container">
                        <a href="info/master.html" class="button">Вступ</a>
                    </div>
                </div>
                <div class="swiper-slide">
                    <img src="https://fireseo.ru/wp-content/uploads/2022/06/programming.jpeg">
                    <div class="button-container">

                        <a href="#news" class="button">Новини</a>
                    </div>
                </div>
            </div>
                ...
                <ul class="news-list">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<div>";
                            echo "<h3><a href=$detailsLink>$title</a></h3>";
